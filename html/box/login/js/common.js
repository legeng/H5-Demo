(function($){
    ...
    commonObj.production = function(){
    		...
    		return flag ? 'http://m.mk.aihuishou.com/' : 'http://www.angellg.com/';
    }
     ...
     * 获取openId
     */
	commonObj.getOpenId = function(url){
		var REDIRECT_URI = encodeURIComponent(url);
		var SCOPE = "snsapi_base";
		var url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx53bd4788711cf125&redirect_uri='+REDIRECT_URI+'&response_type=code&scope='+SCOPE+'&state=1#wechat_redirect';
    ...
    commonObj.wxInit = function(){
        ...
        $.post(__baseUrl + "api/v2/common/sdk/generateConfig", {
