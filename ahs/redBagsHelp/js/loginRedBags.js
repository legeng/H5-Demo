var url = "http://m.mk.aiweixiu.com"+"/api/activity/ahs/common/login";
    ...
    function login(){
		...
		var phoneJson = '{"mobile":"' + $('#tel').val() + '","verifyCode":"' + verifyCode + '","source":"activity","client":"mobile","type":"popup","activityCode":"ACT_718_AuntHelp"}';    		
        $.post(url + "/userLogin", {
            ...
            if(data.code == 0){    
              ...
              //接口
              	    ...
              	    var source="ayibang";
              	    var medium="ayibang";
              	    var campaign="718_AuntHelp";
              	    var sendType='pages';
                    var activityCode = 'ACT_718_AuntHelp';
				    var rangeNum ='1';
