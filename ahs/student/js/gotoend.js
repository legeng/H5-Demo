...
//第一项 双选
	$('.list1 li').on('click',function(){
		...
		$('.section1 li:nth-child(3) img').css('margin','0 1.2rem');
		//已经选择的个数
...
$('.section6').on('click',function(){
	...
	setTimeout(function(){
		window.location="end.html?nickname="+urlParams().nickname+"&type="+urlParams().type+"&index="+Math.floor(Math.random()*100+1);
	},2000)		
})
