$(function(){
	...
	$('.right').on('click',function(){
		window.location='http://m.aihuishou.com/shouji?utm_source=duanxin&utm_medium=M&utm_campaign=ACT_825_JJYJ&piwik_kwd=ACT_825_JJYJ&act=bg&act_activityCode=ACT_825_JJYJ'
	})
